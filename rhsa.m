...
%E0R(1) do E0R(3) E0/R do E3/R
    ...
    y = [u(1)*(zak(1)-z(1))-k(1)*z(1)-k(3)*z(1)^2;
        ...
        -((-u(1)-k(1)-2*k(3)*z(1))*z(5)+k(1)*z(6)+(-k(1)*H(1)-2*z(1)*k(3)*H(3))*z(7));
        -((-u(1)-k(2))*z(6)-k(2)*H(2)*z(7));
        -((-(poch(1)*(z(1)*E0R(1)*(1/z(3)^2)))-(poch(3)*(z(1)^2*E0R(3)*(1/z(3)^2))))*z(5)+((poch(1)*z(1)*(E0R(1)*(1/z(3)^2)))-(poch(2)*z(2)*(E0R(2)*(1/z(3)^2))))*z(6)+(-u(1)-A(1)-(poch(1)*(z(1)*H(1)*E0R(1)*(1/z(3)^2)))-(poch(2)*(z(2)*H(2)*E0R(2)*(1/z(3)^2)))-(poch(3)*(z(1)^2*H(3)*E0R(3)*(1/z(3)^2))))*z(7)+A(2)*z(8));
        -(A(1)*z(7)-A(2)*z(8));
    ];
